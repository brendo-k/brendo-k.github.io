...
the holy trinity of HTML,CSS and JavaScript. The blog posts and project blurbs are written using Hexo, a node.js framework that converts markdown into static pages. This was mainly a learning exercise and lots of the code is poorly written under the hood.
